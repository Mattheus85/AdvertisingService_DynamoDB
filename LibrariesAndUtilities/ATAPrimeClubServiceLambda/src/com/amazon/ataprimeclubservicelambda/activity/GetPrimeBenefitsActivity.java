...
public class GetPrimeBenefitsActivity implements RequestHandler<GetPrimeBenefitsRequest, GetPrimeBenefitsResponse> {
    ...
    /**
     * Handles GetPrimeBenefits requests.  Neither CustomerId nor MarketplaceId can be null.  For all successful calls a
     * list of benefits will be returned.  If the customer is not prime an empty list will be returned.
     *
