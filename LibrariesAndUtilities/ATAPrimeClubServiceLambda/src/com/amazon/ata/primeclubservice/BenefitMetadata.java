...
public class BenefitMetadata implements Comparable<BenefitMetadata> {
    ...
    public static class Builder {
         ...
         *
         * @param benefitLevel The value of the "benefitLevel" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for BenefitMetadata based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for BenefitMetadata based on instanceof and Object.equals().
     */
    @Override
