...
public class GetPrimeBenefitsResponse implements Comparable<GetPrimeBenefitsResponse> {
    ...
    public static class Builder {
         ...
         *
         * @param primeBenefits The value of the "primeBenefits" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for GetPrimeBenefitsResponse based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for GetPrimeBenefitsResponse based on instanceof and Object.equals().
     */
    @Override
