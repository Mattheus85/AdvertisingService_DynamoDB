...
public class PrimeBenefit implements Comparable<PrimeBenefit> {
    ...
    public static class Builder {
         ...
         *
         * @param benefitType The value of the "benefitType" field.
         * @return This builder.
         */
         ...
         *
         * @param benefitMetadata The value of the "benefitMetadata" field.
         * @return This builder.
         */
...
//@Required()
    ...
    /**
     * HashCode implementation for PrimeBenefit based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for PrimeBenefit based on instanceof and Object.equals().
     */
    @Override
