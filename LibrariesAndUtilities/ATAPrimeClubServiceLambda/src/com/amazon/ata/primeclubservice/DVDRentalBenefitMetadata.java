...
public class DVDRentalBenefitMetadata extends BenefitMetadata {
    ...
    public static class Builder extends BenefitMetadata.Builder {
         ...
         *
         * @param noOfDiscOut The value of the "noOfDiscOut" field.
         * @return This builder.
         */
         ...
         *
         * @param monthlyLimit The value of the "monthlyLimit" field.
         * @return This builder.
         */
         ...
         *
         * @param billingSchedule The value of the "billingSchedule" field.
         * @return This builder.
         */
        ...
        /**
         * Sets the fields of the given instances to the corresponding values recorded when calling the "with*"
         * methods.
         *
    ...
    /**
     * HashCode implementation for DVDRentalBenefitMetadata based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for DVDRentalBenefitMetadata based on instanceof and Object.equals().
     */
    @Override
