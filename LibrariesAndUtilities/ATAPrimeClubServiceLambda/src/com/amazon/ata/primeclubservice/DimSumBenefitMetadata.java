...
public class DimSumBenefitMetadata extends BenefitMetadata {
    ...
    public static class Builder extends BenefitMetadata.Builder {
         ...
         *
         * @param checkoutsPerMonth The value of the "checkoutsPerMonth" field.
         * @return This builder.
         */
         ...
         *
         * @param amountOfBooksAvailable The value of the "amountOfBooksAvailable" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for DimSumBenefitMetadata based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for DimSumBenefitMetadata based on instanceof and Object.equals().
     */
    @Override
