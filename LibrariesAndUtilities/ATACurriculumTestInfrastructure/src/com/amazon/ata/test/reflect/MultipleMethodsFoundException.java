...
/**
 * Runtime exception thrown when using {@code MethodQuery} to query for methods but more than one method matched the
 * criteria when requesting a single method match.
 */
