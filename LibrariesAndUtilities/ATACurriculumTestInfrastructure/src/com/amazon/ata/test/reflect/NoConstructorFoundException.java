...
/**
 * Runtime exception thrown when using {@code ConstructorQuery} to query for constructors but no constructors matched
 * the criteria when requesting a single constructor match.
 */
