...
/**
 * Runtime exception thrown when using {@code ConstructorQuery} to query for constructors but more than one constructor
 * matched the criteria when requesting a single constructor match.
 */
