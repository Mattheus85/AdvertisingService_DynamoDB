...
/**
 * Runtime exception thrown when using {@code ClassQuery} to query for classes but more than one class matched the
 * criteria when requesting a single class match.
 */
