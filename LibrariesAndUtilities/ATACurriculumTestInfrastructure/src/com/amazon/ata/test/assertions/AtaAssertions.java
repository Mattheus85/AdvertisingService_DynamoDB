...
public final class AtaAssertions {
    ...
    /**
     * Asserts that the given content contains non-null, non-empty, non-whitespace text between the provided patterns.
     *
     * @param content      The string in which to search between provided patterns
     * @param startPattern The start pattern to search between. Gets compiled into a {@link java.util.regex.Pattern}.
     * @param endPattern   The end pattern to search between. Gets compiled into a {@link java.util.regex.Pattern}.
    ...
    /**
     * Asserts that the given (multiline) content has a match within a single line somewhere in it that corresponds with
    ...
    /**
     * Asserts that {@code expected} and {@code actual} are "close": that {@code actual} is within 1% of
     * {@code expected}.
     * <p>
     * If you would like to specify your own margin of error (e.g. comparing to zero), consider using the
     * {@code assertClose(BigDecimal, BigDecimal, BigDecimal, String)} version of this method.
     *
    ...
    /**
     * Asserts that {@code expected} and {@code actual} are "close", as defined by being within {@code margin} of one
     * another.
     * <p>
     * {@code expected}, {@code actual}, and {@code margin} must all be non-null. {@code margin} must be non-negative.
     *
     * @param expected The expected BigDecimal value
     * @param actual   The actual BigDecimal to compare
