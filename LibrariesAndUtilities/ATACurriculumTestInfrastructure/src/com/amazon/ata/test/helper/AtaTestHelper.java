...
public class AtaTestHelper {
     ...
     *
     * @param filename the name of the resource to get the contents of, relative to a source root (e.g. start the path
     *                 inside .../[Brazil package root]/src)
     ...
     * @param failureSummary Summary of the error condition that occurred (begins the message reported in the assertion
     *                       failure
     */
