...
/**
 * Utility methods to determine if a sequence diagram contains specific content. Decent PlantUML reference visible on
 * Amazon network: http://wiki.plantuml.net/start
 */
public class PlantUmlSequenceDiagramHelper {
     ...
     * <p>
     * The given string must play the role of a participant in the sequence diagram, either explicitly with
     * 'participant/actor/database Entity' or sending/receiving messages from another entity (e.g.
     * {@code Entity -> OtherEntity}, {@code OtherEntity --> Entity}).
     *
     * @param content The contents of the Plant UML diagram
    ...
    /**
     * Determines if a Plant UML sequence diagram contains a message with the specified return type.
    ...
    /**
     * Determines if a Plant UML sequence diagram contains a message with the specified method name attached to it.
     * TODO: Validate this is a return and not just present. Current version is more permissive
     *       than it needs to be.
     * <p>
     * Must use the colon notation to indicate return type (e.g. {@code Entity -> Other : ReturnType})
