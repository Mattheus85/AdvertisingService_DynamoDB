...
public class GetCustomerSpendCategoriesResponse implements Comparable<GetCustomerSpendCategoriesResponse> {
    ...
    public static class Builder {
         ...
         *
         * @param customerSpendCategories The value of the "customerSpendCategories" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for GetCustomerSpendCategoriesResponse based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for GetCustomerSpendCategoriesResponse based on instanceof and Object.equals().
     */
    @Override
