...
public class GetCustomerProfileRequest implements Comparable<GetCustomerProfileRequest> {
    ...
    /**
     * HashCode implementation for GetCustomerProfileRequest based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for GetCustomerProfileRequest based on instanceof and Object.equals().
     */
    @Override
