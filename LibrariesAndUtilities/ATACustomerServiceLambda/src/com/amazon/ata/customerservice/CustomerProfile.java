...
public class CustomerProfile implements Comparable<CustomerProfile> {
    ...
    public static class Builder {
         ...
         *
         * @param homeState The value of the "homeState" field.
         * @return This builder.
         */
         ...
         *
         * @param ageRange The value of the "ageRange" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for CustomerProfile based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for CustomerProfile based on instanceof and Object.equals().
     */
    @Override
