...
public class CustomerSpendCategories implements Comparable<CustomerSpendCategories> {
    ...
    public static class Builder {
         ...
         *
         * @param spendCategories The value of the "spendCategories" field.
         * @return This builder.
         */
...
// @MapKeyConstraint(@NestedConstraints(  enumValues = {@EnumValues({"PRIME_VIDEO","AMAZON_MUSIC","KINDLE","ECHO","FRESH","TECHNICAL_BOOKS","CHILDRENS_BOOKS","MAGAZINES","VIDEO_GAMES","ELECTRONICS","COMPUTERS","HOME","PET"})}))
    ...
    /**
     * HashCode implementation for CustomerSpendCategories based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for CustomerSpendCategories based on instanceof and Object.equals().
     */
    @Override
