...
public class Spend implements Comparable<Spend> {
    ...
    public static class Builder {
         ...
         *
         * @param numberOfPurchases The value of the "numberOfPurchases" field.
         * @return This builder.
         */
         ...
         *
         * @param usdSpent The value of the "usdSpent" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for Spend based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for Spend based on instanceof and Object.equals().
     */
    @Override
