...
public class GetCustomerProfileResponse implements Comparable<GetCustomerProfileResponse> {
    ...
    public static class Builder {
         ...
         *
         * @param customerProfile The value of the "customerProfile" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for GetCustomerProfileResponse based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for GetCustomerProfileResponse based on instanceof and Object.equals().
     */
    @Override
