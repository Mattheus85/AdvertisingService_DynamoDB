...
public class GetCustomerSpendCategoriesRequest implements Comparable<GetCustomerSpendCategoriesRequest> {
    ...
    public static class Builder {
         ...
         *
         * @param marketplaceId The value of the "marketplaceId" field.
         * @return This builder.
         */
         ...
         *
         * @param customerId The value of the "customerId" field.
         * @return This builder.
         */
    ...
    /**
     * HashCode implementation for GetCustomerSpendCategoriesRequest based on java.util.Arrays.hashCode
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Equals implementation for GetCustomerSpendCategoriesRequest based on instanceof and Object.equals().
     */
    @Override
