...
/**
 * Responsible for returning {@code CustomerFunction} objects based on queries for them (for now, supports fetching by
 * function ID only).
 */
public class CustomerFunctionFetcher {
    /**
     * Given a functionId of a function to run, fetches the corresponding {@code CustomerFunction} to run.
     *
