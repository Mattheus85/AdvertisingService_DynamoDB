...
/**
 * Represents a single DevicePart used in building a device. In the AgilePLM system, this includes an ASIN and some
 * metadata. In this example, it's the ASIN and the Responsible GPM's ID.
 */
