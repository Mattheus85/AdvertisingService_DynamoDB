...
public class Futures {
    ...
    /**
     * Helper method that behaves exactly like Future.get(), except that it translates all exceptions to
     * RuntimeException, making it usable in streams. Blocks until completion, just like Future.get().
     *
     ...
     * @throws RuntimeException When Future.get() would throw an ExecutionException: if the process underlying the
