...
public class CategorySpendFrequencyTargetingPredicate extends TargetingPredicate {
     ...
     *                                  For example, if you specify the comparison as Comparison.LT and the targeted
     *                                  number of purchases as 2, this predicate will evaluate to TRUE for all customers
     *                                  who have made less than 2 purchases in the specified category.
