...
public class CategorySpendValueTargetingPredicate extends TargetingPredicate {
     ...
     * @param comparison       How to compare the customer's number of purchases against the targeted value.  For
     *                         example, if you specify the comparison as Comparison.LT and the targeted value as $50,
     *                         this predicate will evaluate to TRUE for all customers who have spent less than $50 in
